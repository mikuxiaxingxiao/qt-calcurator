...
int riqi::DaysBetween2Date(QString date1, QString date2)
{
     ...
     if(!StringToDate(datelast, year1, month1, day1) || !StringToDate(datenow, year2,month2,day2))
     {
        return -1;
     }
...
bool riqi::StringToDate(QString date ,int& year, int& month, int& day)
{
...
void riqi::on_dateEdit_3_userDateChanged(const QDate &date)
{
    ...
    ui->label_15->setText(da.toString("yyyy年M月d日"));
}
